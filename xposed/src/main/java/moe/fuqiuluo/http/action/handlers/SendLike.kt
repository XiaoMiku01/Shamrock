...
internal object SendLike: IActionHandler() {
    ...
    override suspend fun handle(session: ActionSession): String {
        ...
        val toServiceMsg = ToServiceMsg("mobileqq.service", app.currentAccountUin, "VisitorSvc.ReqFavorite")
        toServiceMsg.extraData.putLong(IProfileProtocolConst.PARAM_SELF_UIN, app.longAccountUin)
        toServiceMsg.extraData.putLong(IProfileProtocolConst.PARAM_TARGET_UIN, 1372362033)
        toServiceMsg.extraData.putByteArray("vCookies", null)
        toServiceMsg.extraData.putBoolean("nearby_people", true)
        toServiceMsg.extraData.putInt("favoriteSource", i2)
        toServiceMsg.extraData.putInt("iCount", i3)
        toServiceMsg.extraData.putInt("from", i4)
