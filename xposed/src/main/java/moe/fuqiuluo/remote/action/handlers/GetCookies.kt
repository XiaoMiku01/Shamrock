...
import com.tencent.mobileqq.data.WebCookies
...
internal object GetCookies: IActionHandler() {
    ...
    operator fun invoke(): String {
        ...
        return ok(WebCookies("o_cookie=$uin; ied_qq=o$uin; pac_uid=1_$uin; uin=o$uin; skey=$skey; p_uin=o$uin; p_skey=$pskey;"))
    }
    ...
    operator fun invoke(domain: String): String {
        ...
        return ok(WebCookies("o_cookie=$uin; ied_qq=o$uin; pac_uid=1_$uin; uin=o$uin; skey=$skey; p_uin=o$uin; p_skey=$pskey; pt4_token=$pt4token;"))
    }
